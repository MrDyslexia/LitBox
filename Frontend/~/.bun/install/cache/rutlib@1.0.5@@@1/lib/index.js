...
exports.compareRuts = exports.generateRut = exports.formatRut = exports.getLastDigitOfRut = exports.validateRut = exports.cleanRut = void 0;
...
function compareRuts(rut1, rut2) {
    /**
     * Compare two RUTs.
     ...
     */
    // Clean the RUTs
    var cleanedRut1 = cleanRut(rut1);
    var cleanedRut2 = cleanRut(rut2);
    // Validate the RUTs
...
exports.compareRuts = compareRuts;
